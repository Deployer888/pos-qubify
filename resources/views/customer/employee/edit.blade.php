        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-validate" action="{{ route('customer.employee.update', $customer->id) }}"
                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                            ...
                                            <select id="country" name="country" class="form-control select2">
                                                ...
                                                @foreach ($countries as $country)
                                                    <option value="{{ $country->id }}"
                                                        @if ($country->id == $customer->country) selected @endif>
                                                        {{ $country->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group col-sm-6">
                                        ...
                                        <input type="number" name="zipcode" class="form-control"
                                            value="{{ $customer->zipcode }}" maxlength="12">
                                        @error('zipcode')
                                            <p class="error">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <textarea name="short_address" class="form-control" id="short_address" placeholder="{{ __t('short_address') }}">{{ $customer->short_address ?? old('short_address') }}</textarea>
                                        @error('short_address')
                                            <p class="error">{{ $message }}</p>
                                        @enderror
                                    </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        <div class="form-check custom-control custom-checkbox">
                                            <input class="form-check-input custom-control-input" type="checkbox"
                                                value="1" id="billingSameAsAddress" name="billing_same"
                                                @if ($customer->billing_same) checked @endif>
                                    ...
                                    <div class="col-lg-6 b_hide_same">
                                        <div class="form-group ic-select-gray-bg">
                                            <label for="#">{{ __('custom.country') }}</label>
                                            <select id="country2" name="b_country" class="form-control select2">
                                                ...
                                                @foreach ($countries as $country)
                                                    <option value="{{ $country->id }}"
                                                        @if ($country->id == $customer->b_country) selected @endif>
                                                        {{ $country->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group col-lg-6 b_hide_same">
                                        <label for="">{{ __('custom.zipcode') }}</label>
                                        <input type="number" name="b_zipcode" class="form-control"
                                            value="{{ $customer->b_zipcode }}" maxlength="12">
                                        @error('zipcode')
                                            <p class="error">{{ $message }}</p>
                                        @enderror
                                    </div>

                                    <div class="form-group col-sm-12 b_hide_same">
                                ...
                                <div class="row">
                                    <div class="col-sm-8">
                                        <div class="form-group">
                                            <input type="file" id="uploadFile" class="f-input form-control"
                                                name="avatar">
                                        </div>
                                        @error('avatar')
                                            <p class="error">{{ $message }}</p>
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="status_yes"
                                        ...
                                        class="custom-control-input" @if (\App\Models\Customer::STATUS_ACTIVE == $customer->status) checked @endif>
                                ...
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="status_no"
                                        ...
                                        class="custom-control-input" @if (\App\Models\Customer::STATUS_INACTIVE == $customer->status) checked @endif>
                                    <label class="custom-control-label"
...
@push('script')
    <script>
        $(document).ready(function() {
            ...
            if ($('#billingSameAsAddress').is(':checked')) {
                $('.b_hide_same').hide();
