                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr
                                                ...
                                                <td class="content-block"
                                                    ...
                                                    valign="top">
                                                    Your return invoice request has been received. You can view your return
                                                    invoice by clicking the link below.
                                                </td>
                                            </tr>
                                            <tr
                                                style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                                <td class="content-block"
                                                    style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                                    valign="top">
                                                    Please review the invoice carefully and contact our support team if you
                                                    have any questions.
                                                </td>
                                            </tr>
                                            <tr
                                                ...
                                                <td class="content-block" itemprop="handler" itemscope
                                                    ...
                                                    style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                                    valign="top">
                                                    <a href="{{ route('admin.products-return-request.show', $data->id) }}"
