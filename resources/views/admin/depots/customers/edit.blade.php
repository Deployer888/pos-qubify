...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="mt-0 header-title">Edit Customer - {{ $depot->depot_type }}</h4>

                <form action="{{ route('admin.depots.customers.update', [$depot, $customer]) }}" method="POST" class="mt-4">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="family_id" 
                                       name="family_id" 
                                       value="{{ old('family_id', $customer->family_id) }}" 
                                       required>
                                @error('family_id')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="adhaar_no" 
                                       name="adhaar_no" 
                                       value="{{ old('adhaar_no', $customer->adhaar_no) }}"
                                       pattern="[0-9]{12}"
                                       maxlength="12"
                                       required>
                                @error('adhaar_no')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="ration_card_no" 
                                       name="ration_card_no" 
                                       value="{{ old('ration_card_no', $customer->ration_card_no) }}" 
                                       required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       id="card_range" 
                                       name="card_range" 
                                       value="{{ old('card_range', $customer->card_range) }}" 
                                       required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-switch mt-2">
                                    <input type="checkbox" 
                                           ...
                                           name="is_family_head" 
                                           value="1"
                                           {{ old('is_family_head', $customer->is_family_head) ? 'checked' : '' }}>
