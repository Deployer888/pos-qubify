...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="mt-0 header-title">Add New Beneficiary</h4>

                <form action="{{ route('admin.beneficiaries.store') }}" method="POST" class="mt-4">
                    @csrf
                    <div class="row">
                        <!-- Depot Selection -->
                        <div class="col-md-6">
                                ...
                                <select class="form-control @error('depot_id') is-invalid @enderror" 
                                    ...
                                    @foreach($depots as $depot)
                                        <option value="{{ $depot->id }}" 
                                                {{ old('depot_id') == $depot->id ? 'selected' : '' }}>
