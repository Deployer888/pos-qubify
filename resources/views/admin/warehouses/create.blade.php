                ...
                <form class="form-validate" action="{{ route('admin.warehouses.store') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            <label for="">{{__('custom.barcode')}} <span class="error">*</span></label>
                            <div class="row">
                                <div class="col-sm-8">
                                    <input type="text" id="barcode" name="barcode" class="form-control"
                                           placeholder="Product Barcode" value="{{ Carbon\Carbon::now()->timestamp }}">
                                    @error('barcode')
                                    <p class="error">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group col-sm-6 col-lg-6 col-xl-4">
                            <label for="">{{__('custom.priority')}}<small>
...
{{--                                </p>--}}
                        ...
                        <div class="form-group col-sm-6 col-lg-6 col-xl-4">
                            ...
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" name="is_default" {{ old('is_default') ? 'checked' : '' }} value="1"
                                    id="is_default">
