...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'permission.super' => \App\Http\Middleware\CheckPermissionOrSuperAdmin::class,
        ...
        'api.checkIsAdmin'          => \App\Http\Middleware\ApiCheckIsAdmin::class,
        'api.checkIsCustomer'       => \App\Http\Middleware\ApiCheckIsCustomer::class,
        'depot.dashboard'           => \App\Http\Middleware\DepotDashboardAccess::class,
        'api.checkApiKey'       => \App\Http\Middleware\CheckApiKeyMiddleware::class,
    ];
}
